...
namespace Aurora {
	namespace Random {
		...
		std::shared_ptr<Aurora::Physics::Force<float>> Aurora::Random::IOscillatorImplementor::AccessObjectPhysics() const
		{
			return nullptr;
		}
		...
		Oscillator::Oscillator(const mRECT<float> &areaSize) : RandomBaseComplete()
		{
