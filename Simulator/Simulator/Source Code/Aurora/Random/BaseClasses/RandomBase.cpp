...
namespace Aurora {
    namespace Random {
		...
		void IRandomBaseBasic::SetConstrainsRange(const Aurora::Math::DataTypes::mRECT<float> &areaSize)
		{
			this->areaSize = areaSize;
		}

		const Aurora::Math::DataTypes::mRECT<float> IRandomBaseBasic::GetConstrainsRange() const
		{
		...
		{
			this->init(Aurora::Math::DataTypes::mRECT<float>(0, 0), RandomNumberMode::Normal);
		}


		void RandomBase::init(const Aurora::Math::DataTypes::mRECT<float> &areaSize, RandomNumberMode randomNumberMode)
		{
		...
		void RandomBaseComplete::init(const Aurora::Math::DataTypes::mRECT<float> &areaSize, RandomNumberMode randomNumberMode)
		{
		...
		void RandomBasePerlinNoise::init(const Aurora::Math::DataTypes::mRECT<float> &areaSize, RandomNumberMode randomNumberMode)
		{
			RandomBase::init(areaSize, randomNumberMode);
			this->perlinNoiseCalculator = std::make_shared <module::Perlin>();
		}
		...
		void RandomBaseGaussian::init(const Aurora::Math::DataTypes::mRECT<float> &areaSize, RandomNumberMode randomNumberMode)
		{
			RandomBase::init(areaSize, randomNumberMode);
		}
		...
		void RandomBaseUniform::init(const Aurora::Math::DataTypes::mRECT<float> &areaSize, RandomNumberMode randomNumberMode)
		{
			RandomBase::init(areaSize, randomNumberMode);
		}
		...
		void RandomBaseNormal::init(const Aurora::Math::DataTypes::mRECT<float> &areaSize, RandomNumberMode randomNumberMode)
		{
			RandomBase::init(areaSize, randomNumberMode);
		}
