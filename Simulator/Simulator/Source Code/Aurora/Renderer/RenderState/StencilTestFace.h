...
namespace Aurora {
	namespace Renderer {
		...
		public:
			...
			Aurora::Renderer::StencilOperation StencilFailOperation() const {
			...
			Aurora::Renderer::StencilOperation DepthFailStencilPassOperation() const {
			...
			Aurora::Renderer::StencilOperation DepthPassStencilPassOperation() const {
			...
			Aurora::Renderer::StencilTestFunction Function() const {
				return function;
			}
			template<typename T>
