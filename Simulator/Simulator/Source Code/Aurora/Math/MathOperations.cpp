...
namespace Aurora
{
	...
	*/
	namespace Math
	{
		...
		//void  MathOperations::VERTEX2DToPOLAR2D(mPOLAR2D *polar, VECTOR2D<Type> &point)
		//{
		...
		//void  MathOperations::POLAR2DToVERTEX2D(VECTOR2D<Type> *point, mPOLAR2D &polar)
		//{
		...
		//void  MathOperations::VERTEX2DToPolarRTh(Float *r, Float *theta, VECTOR2D<Type> &point)
		//{
		//	// convert rectangular to polar
		...
		//void ComputeParmLine2D(VECTOR2D<Type> *point, const mPARAMETRICLINE2D &line, float t)
		//{
