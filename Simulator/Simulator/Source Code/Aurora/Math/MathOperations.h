...
namespace Aurora
{
	...
	*/
	namespace Math
	{
		...
		//		\param &point
		//		*/
		//		static void VERTEX2DToPOLAR2D(mPOLAR2D *polar, VECTOR2D<Type> &point);
		//		/*!
		//		\brief
		//		\param *point
		//		\param &polar
		//		*/
		//		static void POLAR2DToVERTEX2D(VECTOR2D<Type> *point, mPOLAR2D &polar);
		//		/*!
		//		\brief
		//		\param *x
		//		\param *y
		...
		//		\param &point
		//		*/
		//		static void VERTEX2DToPolarRTh(Float *r, Float *theta, VECTOR2D<Type> &point);
		...
		// * \param t 
		// */
		//extern void ComputeParmLine2D(VECTOR2D<Type> *point, const mPARAMETRICLINE2D &line, float t);
